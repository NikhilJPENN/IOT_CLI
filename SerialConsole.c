...
* Defines
******************************************************************************/
#define RX_BUFFER_SIZE 550	///<Size of character buffer for RX, in bytes
#define TX_BUFFER_SIZE 550	///<Size of character buffers for TX, in bytes
...
void gettempString(char * buffer, char * tempString, int len){
int i = 0;
for (i; i < len; i++)
{
...
backspace[1] = 0x20; 
backspace[2] = NULL;
//SerialConsoleWriteString("Nikhil");
